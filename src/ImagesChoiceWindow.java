...
public class ImagesChoiceWindow extends JFrame{

	private AnswererWindow myAnswerer; 
	public static final String RESOURCES_PATH = "src/resources/";
	public ImagesChoiceWindow(AnswererWindow answerer){
		myAnswerer = answerer;
		initUI();
	}
		...
		try {
			...
			picLabel1.addMouseListener(new MouseAdapter(){
				...
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"cat2.jpg");
					dispose();
				}
			});
			add(picLabel1);
			...
			picLabel2.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"basketball2.jpg");
					dispose();
				}
			});
			add(picLabel2);
			...
			picLabel3.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"butterfly2.jpg");
					dispose();
				}
			});
			add(picLabel3);
			...
			picLabel4.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"cake2.jpg");
					dispose();
				}
			});
			add(picLabel4);
			...
			picLabel5.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"detective2.jpg");
					dispose();
				}
			});
			add(picLabel5);
			...
			picLabel6.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"frog2.jpg");
					dispose();
				}
			});
			add(picLabel6);
			...
			picLabel7.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"ladybug2.jpg");
					dispose();
				}
			});
			add(picLabel7);
			...
			picLabel8.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"moon2.jpg");
					dispose();
				}
			});
			add(picLabel8);
			...
			picLabel9.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"panda2.jpg");
					dispose();
				}
			});
			add(picLabel9);
			...
			picLabel10.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"pineapple2.jpg");
					dispose();
				}
			});
			add(picLabel10);
			...
			picLabel11.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"snowman2.jpg");
					dispose();
				}
			});
			add(picLabel11);
			...
			picLabel12.addMouseListener(new MouseAdapter(){
				@Override
				public void mouseClicked(MouseEvent e){
					myAnswerer.changeTo(RESOURCES_PATH+"strawberry2.jpg");
					dispose();
				}
			});
			add(picLabel12);
